...
void CEcgModule::f_plot_ecg_wave(int data1,int data2,int data3)
{
    ...
    {
        dstep = m_ecg_pos[0] +WAVE_WIDGET_WIDTH_PIX- m_ecg_last_pos[0];
    }
    if(dstep >=1)
    {
        //double x = m_ecg_pos[0] - m_ecg_last_pos[0];
 ...
 */
    ...
    {
        dstep = m_spire_pos + WAVE_WIDGET_WIDTH_PIX - m_spire_last_pos;
    }
    if(dstep >=1)
    {
        if(m_spire_cfg->m_wave_enable)
...
/*
    ...
    */
    ...
    {
        dstep = m_spo2_pos + WAVE_WIDGET_WIDTH_PIX - m_spo2_last_pos;
    }
    if(dstep >=1)
    {
        if(m_spo2_cfg->m_wave_enable)
