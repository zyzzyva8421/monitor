...
CDlgServTiwentantou::CDlgServTiwentantou(QWidget * parent,QWidget *pMain):QDialog(parent)
{
    iCursor = 0;
    bCursorSta = false;
    pMainForm = pMain;
...
void CDlgServTiwentantou::do_ok_clicked()
{

    close();
}
void CDlgServTiwentantou::do_cancel_clicked()
{
    close();
}
bool CDlgServTiwentantou::eventFilter(QObject *o,QEvent *e)
{
    QObject *obj[]={
        m_cmbb_style
        ,m_btn_ok
