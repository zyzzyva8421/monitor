...
#define        G_WARN_T_TXT_STARTVOICE    " " //开机

//声音文件
#define  G_WARN_FILE_PATH   "/home/data/wav/"
#define     G_WARN_NO_WARNING                       "highalarm.wav"        //无报警
...
#define		G_WARN_P_FILE_HRHIGH					"hrhigh_cn.wav" 			// * * 心率太高	心率超过报警高限	高
#define		G_WARN_P_FILE_HRHLOW					"hrlow_cn.wav" 			// * * 心率太低	心率低于报警低限	高
#define		G_WARN_P_FILE_ST1HIGH					"sthigh_cn.wav" 			// * * ST-I太高	I导联ST值超过报警高限	高
#define		G_WARN_P_FILE_ST1LOW					"stlow_cn.wav" 			// * * ST-I太低	I导联ST值低于报警低限	高
#define		G_WARN_P_FILE_ST2HIGH					"sthigh_cn.wav" 			// * * ST-II太高	II导联ST值超过报警高限	高
#define		G_WARN_P_FILE_ST2LOW					"stlow_cn.wav" 			// * * ST-II太低	II导联ST值低于报警低限	高
#define		G_WARN_P_FILE_ST3HIGH					"sthigh_cn.wav" 			// * * ST-III太高	III导联ST值超过报警高限	高
#define		G_WARN_P_FILE_ST3LOW					"stlow_cn.wav" 			// * * ST-III太低	III导联ST值低于报警低限	高
#define		G_WARN_P_FILE_STAVRHIGH	  		"sthigh_cn.wav" 			// * * ST-AVR太高	AVR导联ST值超过报警高限	高
#define		G_WARN_P_FILE_STAVRLOW	  		"stlow_cn.wav" 			// * * ST-AVR太低	AVR导联ST值低于报警低限	高
#define		G_WARN_P_FILE_STAVLHIGH	  		"sthigh_cn.wav" 			// * * ST-AVL太高	AVL导联ST值超过报警高限	高
#define		G_WARN_P_FILE_STAVLLOW	  		"stlow_cn.wav" 			// * * ST-AVL太低	AVL导联ST值低于报警低限	高
#define		G_WARN_P_FILE_STAVFHIGH				"sthigh_cn.wav"			// * * ST-AVF太高	AVF导联ST值超过报警高限	高
#define		G_WARN_P_FILE_STAVFLOW	  		"stlow_cn.wav"			// * * ST-AVF太低	AVF导联ST值低于报警低限	高
#define		G_WARN_P_FILE_STVHIGH	    		"sthigh_cn.wav"			// * * ST-V太高	V导联ST值超过报警高限	高
#define		G_WARN_P_FILE_STVLOW		  		"stlow_cn.wav"			// * * ST-V太低	V导联ST值低于报警低限	高
#define		G_WARN_P_FILE_PVCHIGH	    		"highalarm.wav"			// * * PVCs太高	PVCs值超过报警高限	高
#define		G_WARN_P_FILE_SPO2HIGH	  		"spo2high_cn.wav"			// * * 氧饱和度太高	氧饱和度超过报警高限	中
#define		G_WARN_P_FILE_SPO2LOW		  		"spo2low_cn.wav"			// * * 氧饱和度太低	氧饱和度低于报警低限	中
#define		G_WARN_P_FILE_PRHIGH		  		"prhigh_cn.wav"			// * * 脉率太高	脉率超过报警高限	中
#define		G_WARN_P_FILE_PRLOW			  		"prlow_cn.wav"			// * * 脉率太低	脉率低于报警低限	中
#define		G_WARN_P_FILE_NSHIGH					"nshigh_cn.wav"			// * * 收缩压太高	收缩压超过报警高限	中
#define		G_WARN_P_FILE_NSLOW						"nslow_cn.wav"			// * * 收缩压太低	收缩压低于报警低限	中
#define		G_WARN_P_FILE_NMHIGH					"nmhigh_cn.wav"			// * * 平均压太高	平均压超过报警高限	中
#define		G_WARN_P_FILE_NMLOW						"nmlow_cn.wav"			// * * 平均压太低	平均压低于报警低限	中
#define		G_WARN_P_FILE_NDHIGH					"ndhigh_cn.wav"			// * * 舒张压太高	舒张压超过报警高限	中
#define		G_WARN_P_FILE_NDLOW						"ndlow_cn.wav"			// * * 舒张压太低	舒张压低于报警低限	中
#define		G_WARN_P_FILE_RRHIGH					"highalarm.wav"			// * * 呼吸率太高	呼吸率超过报警高限	中
#define		G_WARN_P_FILE_RRLOW						"highalarm.wav"			// * * 呼吸率太低	呼吸率低于报警低限	中
#define		G_WARN_P_FILE_TEMP1HIGH	  		"temp1high_cn.wav"			// * * 体温通道1太高	体温通道1超过报警高限	中
#define		G_WARN_P_FILE_TEMP1LOW	  		"temp1low_cn.wav"			// * * 体温通道1太低	体温通道1低于报警低限	中
#define		G_WARN_P_FILE_TEMP2HIGH	  		"temp2high_cn.wav"			// * * 体温通道2太高	体温通道2超过报警高限	中
#define		G_WARN_P_FILE_TEMP2LOW	  		"temp2low_cn.wav"			// * * 体温通道2太低	体温通道2低于报警低限	中
#define		G_WARN_P_FILE_IBP1NSHIGH	        		"ishigh_cn.wav"			// * * 主动脉压收缩压太高	主动脉收缩压超过报警高限	中
#define		G_WARN_P_FILE_IBP1NSLOW	        		"islow_cn.wav"			// * * 主动脉压收缩压太低	主动脉收缩压低于报警低限	中
#define		G_WARN_P_FILE_IBP1NMHIGH	        		"imhigh_cn.wav"			// * * 主动脉压平均压太高	主动脉平均压超过报警高限	中
#define		G_WARN_P_FILE_IBP1NMLOW		        		"imlow_cn.wav"			// * * 主动脉压平均压太低	主动脉平均压低于报警低限	中
#define		G_WARN_P_FILE_IBP1NDHIGH	        		"idhigh_cn.wav"			// * * 主动脉压舒张压太高	主动脉舒张压超过报警高限	中
#define		G_WARN_P_FILE_IBP1NDLOW	        		"idlow_cn.wav"			// * * 肺动脉压舒张压太低	肺动脉舒张压低于报警低限	中
#define		G_WARN_P_FILE_IBP2NSHIGH	        		"highalarm.wav"			// * * 肺动脉压收缩压太高	肺动脉收缩压超过报警高限	中
#define		G_WARN_P_FILE_IBP2NSLOW		        		"highalarm.wav"			// * * 肺动脉压收缩压太低	肺动脉收缩压低于报警低限	中
#define		G_WARN_P_FILE_IBP2NMHIGH	        		"highalarm.wav"			// * * 肺动脉压平均压太高	肺动脉平均压超过报警高限	中
#define		G_WARN_P_FILE_IBP2NMLOW	        		"highalarm.wav"			// * * 肺动脉压平均压太低	肺动脉平均压低于报警低限	中
#define		G_WARN_P_FILE_IBP2NDHIGH	        		"highalarm.wav"			// * * 肺动脉压舒张压太高	肺动脉舒张压超过报警高限	中
#define		G_WARN_P_FILE_IBP2NDLOW	        		"highalarm.wav"			// * * 肺动脉压舒张压太低	肺动脉舒张压低于报警低限	中
#define		G_WARN_P_FILE_IBP3NSHIGH	        		"highalarm.wav"			// * * 中心静脉压收缩压太高	中心静脉收缩压超过报警高限	中
#define		G_WARN_P_FILE_IBP3NSLOW	        		"highalarm.wav"			// * * 中心静脉压收缩压太低	中心静脉收缩压低于报警低限	中
#define		G_WARN_P_FILE_IBP3NMHIGH	        		"highalarm.wav"			// * * 中心静脉压平均压太高	中心静脉平均压超过报警高限	中
#define		G_WARN_P_FILE_IBP3NMLOW	        		"highalarm.wav"			// * * 中心静脉压平均压太低	中心静脉平均压低于报警低限	中
#define		G_WARN_P_FILE_IBP3NDHIGH	        		"highalarm.wav"			// * * 中心静脉压舒张压太高	中心静脉舒张压超过报警高限	中
#define		G_WARN_P_FILE_IBP3NDLOW	        		"highalarm.wav"			// * * 中心静脉压舒张压太低	中心静脉舒张压低于报警低限	中
#define		G_WARN_P_FILE_IBP4NSHIGH		        		"highalarm.wav"			// * * 左房压收缩压太高	左房收缩压超过报警高限	中
#define		G_WARN_P_FILE_IBP4NSLOW	        		"highalarm.wav"			// * * 左房压收缩压太低	左房收缩压低于报警低限	中
#define		G_WARN_P_FILE_IBP4NMHIGH		        		"highalarm.wav"			// * * 左房压平均压太高	左房平均压超过报警高限	中
#define		G_WARN_P_FILE_IBP4NMLOW			        		"highalarm.wav"			// * * 左房压平均压太低	左房平均压低于报警低限	中
#define		G_WARN_P_FILE_IBP4NDHIGH		        		"highalarm.wav"			// * * 左房压舒张压太高	左房舒张压超过报警高限	中
#define		G_WARN_P_FILE_IBP4NDLOW			        		"highalarm.wav"			// * * 左房压舒张压太低	左房舒张压低于报警低限	中
#define		G_WARN_P_FILE_IBP5NSHIGH		        		"highalarm.wav"			// * * 右房压收缩压太高	右房收缩压超过报警高限	中
#define		G_WARN_P_FILE_IBP5NSLOW			        		"highalarm.wav"			// * * 右房压收缩压太低	右房收缩压低于报警低限	中
#define		G_WARN_P_FILE_IBP5NMHIGH		        		"highalarm.wav"			// * * 右房压平均压太高	右房平均压超过报警高限	中
#define		G_WARN_P_FILE_IBP5NMLOW			        		"highalarm.wav"			// * * 右房压平均压太低	右房平均压低于报警低限	中
#define		G_WARN_P_FILE_IBP5NDHIGH		        		"highalarm.wav"			// * * 右房压舒张压太高	右房舒张压超过报警高限	中
#define		G_WARN_P_FILE_IBP5NDLOW			        		"highalarm.wav"			// * * 右房压舒张压太低	右房舒张压低于报警低限	中
#define		G_WARN_P_FILE_IBP6NSHIGH		        		"highalarm.wav"			// * * 颅内压收缩压太高	颅内收缩压超过报警高限	中
#define		G_WARN_P_FILE_IBP6NSLOW			        		"highalarm.wav"			// * * 颅内压收缩压太低	颅内收缩压低于报警低限	中
#define		G_WARN_P_FILE_IBP6NMHIGH		        		"highalarm.wav"			// * * 颅内压平均压太高	颅内平均压超过报警高限	中
#define		G_WARN_P_FILE_IBP6NMLOW			        		"highalarm.wav"			// * * 颅内压平均压太低	颅内平均压低于报警低限	高
#define		G_WARN_P_FILE_IBP6NDHIGH		        		"highalarm.wav"			// * * 颅内压舒张压太高	颅内舒张压超过报警高限	高
#define		G_WARN_P_FILE_IBP6NDLOW			        		"highalarm.wav"			// * * 颅内压舒张压太低	颅内舒张压低于报警低限	高
#define		G_WARN_P_FILE_IBP7NSHIGH		        		"highalarm.wav"			// * * P1压太高	P1收缩压超过报警高限	高
#define		G_WARN_P_FILE_IBP7NSLOW			        		"highalarm.wav"			// * * P1压太低	P1收缩压低于报警低限	高
#define		G_WARN_P_FILE_IBP7NMHIGH		        		"highalarm.wav"			// * * P1平均压太高	P1平均压超过报警高限	高
#define		G_WARN_P_FILE_IBP7NMLOW			        		"highalarm.wav"			// * * P1平均压太低	P1平均压低于报警低限	高
#define		G_WARN_P_FILE_IBP7NDHIGH		        		"highalarm.wav"			// * * P1舒张压太高	P1舒张压超过报警高限	高
#define		G_WARN_P_FILE_IBP7NDLOW			        		"highalarm.wav"			// * * P1舒张压太低	P1舒张压低于报警低限	高
#define		G_WARN_P_FILE_IBP8NSHIGH		        		"highalarm.wav"			// * * P2压太高	P2收缩压超过报警高限	高
#define		G_WARN_P_FILE_IBP8NSLOW			        		"highalarm.wav"			// * * P2压太低	P2收缩压低于报警低限	高
#define		G_WARN_P_FILE_IBP8NMHIGH		        		"highalarm.wav"			// * * P2平均压太高	P2平均压超过报警高限	高
#define		G_WARN_P_FILE_IBP8NMLOW			        		"highalarm.wav"			// * * P2平均压太低	P2平均压低于报警低限	高
#define		G_WARN_P_FILE_IBP8NDHIGH		        		"highalarm.wav"			// * * P2舒张压太高	P2舒张压超过报警高限	高
#define		G_WARN_P_FILE_IBP8NDLOW			        		"highalarm.wav"			// * * P2舒张压太低	P2舒张压低于报警低限	高
#define		G_WARN_P_FILE_ETCO2HIGH         "co2high_cn.wav"			// * * 呼末CO₂太高	呼末CO₂超过报警高限	中
#define		G_WARN_P_FILE_ETCO2LOW          "co2low_cn.wav"			// * * 呼末CO₂太低	呼末CO₂低于报警低限	中
#define		G_WARN_P_FILE_FICO2HIGH		        		"highalarm.wav"			// * * 吸末CO₂太高	吸末CO₂超过报警高限	中
#define		G_WARN_P_FILE_FICO2LOW	        		"highalarm.wav"			// * * 吸末CO₂太低	吸末CO₂低于报警低限	中
#define		G_WARN_P_FILE_SPHIGH	        		"rrhigh_cn.wav"			// * * 气道呼吸率太高	气道呼吸率超过报警高限	中
#define		G_WARN_P_FILE_SPLOW	        		"rrlow_cn.wav"  		// * * 气道呼吸率太低	气道呼吸率低于报警低限	中


//		报警信息	触发条件		报警优先级
#define		G_WARN_T_FILE_ECGLEADOFF     "ecgleadoff_cn.wav"			// * * 心电导联脱落	RL或2个以上的心电导联脱落		低
#define		G_WARN_T_FILE_RALEADOFF         "raleadoff_cn.wav"			// * * 心电导联RA脱落	RA导联脱落		低
#define		G_WARN_T_FILE_LALEADOFF         "laleadoff_cn.wav"			// * * 心电导联LA脱落	LA导联脱落		低
#define		G_WARN_T_FILE_LLLEADOFF         "llleadoff_cn.wav"			// * * 心电导联LL脱落	LL导联脱落		低
#define		G_WARN_T_FILE_VLEADOFF           "vleadoff_cn.wav"			// * * 心电导联V脱落	V导联脱落		低
#define		G_WARN_T_FILE_MODUINITERR    "highalarm.wav"			// * * 模块初始化错	模块自检错误		低
#define		G_WARN_T_FILE_COMMSTOP				  		"commstop_cn.wav"			// * * *模块通讯停止	模块和主机通讯出现问题		低
#define		G_WARN_T_FILE_COMMERR							"commerr_cn.wav"			// * * 模块通讯错	模块和主机通讯出现问题		低
#define		G_WARN_T_FILE_WARNLIMITERR								  		"highalarm.wav"			// * * 参数报警限错	参数的报警限被意外改动		低
#define		G_WARN_T_FILE_PARALIMITERR								  		"highalarm.wav"			// * * 测量范围超界	参数的测量值超出了系统所能进行的测量范围		低
#define		G_WARN_T_FILE_SPO2SENSER			  		"spo2sensor_cn.wav"			// * * 血氧探头脱落	血氧探头未接好		低
#define		G_WARN_T_FILE_SPO2FINGER			  		"spo2finger_cn.wav"			// * * 血氧探头手指脱落	手指从血氧探头中脱落		低
#define		G_WARN_T_FILE_SEARCHPULSE							  		"highalarm.wav"			// * * 搜索脉搏...	血氧探头没有连接好或病人运动手臂		低
#define		G_WARN_T_FILE_TEMP1SENSOR					"tempsensor_cn.wav"			// * * 体温通道1探头脱落	体温通道1探头未接好		低
#define		G_WARN_T_FILE_TEMP2SENSOR					"tempsensor_cn.wav"			// * * 体温通道2探头脱落	体温通道2探头未接好		低
#define		G_WARN_T_FILE_WATCHDOGERR							  		"highalarm.wav"			// * * 看门狗错误	主机看门狗自检失败		低
#define		G_WARN_T_FILE_SYSTIMEERR								  		"highalarm.wav"			// * * 系统时间丢失	系统时钟未设置		低
#define		G_WARN_T_FILE_12VHIGH							  		"highalarm.wav"			// * * 12V电压太高	12V电压检测超出正常电压范围		低
#define		G_WARN_T_FILE_12VLOW							  		"highalarm.wav"			// * * 12V电压太低	12V电压检测低于正常电压范围		低
#define		G_WARN_T_FILE_3_3VHIGH							  		"highalarm.wav"			// * * 3.3V电压太高	3.3V电压检测超出正常电压范围		低
#define		G_WARN_T_FILE_3_3VLOW							  		"highalarm.wav"			// * * 3.3V电压太低	3.3V电压检测低于正常电压范围		低
#define		G_WARN_T_FILE_BATHIGH							  		"highalarm.wav"			// * * 电池电压太高	电池电压检测超出正常电压范围		低
#define		G_WARN_T_FILE_BATLOW							  		"batlow_cn.wav"			// * * 电池不足，请立即充电	电池电量不足		低
#define		G_WARN_T_FILE_TIELOOSE							  		"highalarm.wav"			// * 无创血压袖带松	袖带未连接好		低
#define		G_WARN_T_FILE_NBPLEAK							"nbpleak_cn.wav"			// * 无创血压漏气	袖带未连接好或气路漏气		低
#define		G_WARN_T_FILE_NBPAIRERR						"nbppairerr_cn.wav"			// * 无创血压放气错误	血压测量时放气出现问题		低
#define		G_WARN_T_FILE_NBPWEAK							"nbpweak_cn.wav"			// * 无创血压信号太弱	血压测量时脉搏信号太弱，无法计算出血压		低
#define		G_WARN_T_FILE_NBPEXD					  		"nbpexd_cn.wav"			// * 无创血压测量超界	血压测量时血压或脉搏信号超出正常范围，无法进行测量		低
#define		G_WARN_T_FILE_NBPMOVE							"nbpmove_cn.wav"			// * 无创血压手臂运动	病人手臂运动		低
#define		G_WARN_T_FILE_NBPOVERPRESSURE			"nbpoverpressure_cn.wav"			// * * 无创血压过压	压力值超过测量范围		低
#define		G_WARN_T_FILE_NBPSAT					  		"nbpsat_cn.wav"			// * 无创血压信号饱和	血压测量时脉搏信号超出正常范围，无法进行测量		低
#define		G_WARN_T_FILE_NBPLEAKCKFAIL							  		"highalarm.wav"			// * 无创血压漏气检测失败	袖带未连接好或气路漏气		低
#define		G_WARN_T_FILE_NBPFAIL							"nbpfail_cn.wav"			// * * 无创血压系统错误	血压系统自检失败，一般是压力传感器实效导致自检失败		低
#define		G_WARN_T_FILE_NBPTIMEOUT			  		"nbptimeout_cn.wav"			// * * 无创血压测量超时	血压测量超时		低
#define		G_WARN_T_FILE_NBPTIEERR							  		"highalarm.wav"			// * * 无创血压袖带类型错	病人类型为成人时使用了新生儿袖带		低
#define		G_WARN_T_FILE_NBPMESSUREFAIL		  		"highalarm.wav"			// * * 无创血压测量失败	本次血压测量未能计算出血压		低
#define		G_WARN_T_FILE_NBPRESETERR							  		"highalarm.wav"			// * * 无创血压非法复位	血压测量时异常复位		低
#define		G_WARN_T_FILE_CO2STANDBY								  		"highalarm.wav"			// * * CO₂待命	CO₂处于待命状态		低
#define		G_WARN_T_FILE_CO2STOP							  		"highalarm.wav"			// * * *CO₂通讯停止	CO₂模块和主机通讯出现问题		低
#define      G_WARN_T_FILE_HEARTV   "heart.wav"
#define      G_WARN_T_FILE_STARTVOICE "start.wav"
